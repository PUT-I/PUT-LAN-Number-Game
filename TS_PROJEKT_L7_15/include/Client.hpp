...
public:
	...
	void startGame() {
		...
		//Wyświetlenie informacji o zasadach rozgrywki
		{
			...
			sync_cout << GetCurrentTimeTm() << " : " << "YOU HAVE 30 SECONDS BEFORE GAME STARTS.\n";
			sync_cout << GetCurrentTimeTm() << " : " << "EACH PLAYER TRIES TO GUESS RANDOM NUMBER(0-255) GENERATED BY SERVER.\n";
		...
		CONSOLE_MANIP::cursor_set_pos(0, CONSOLE_MANIP::cursor_get_pos().Y);
		sync_cout << GetCurrentTimeTm() << " : " << "GAME START.      \n";
